    ...
    res.render("portfolio", {
        portfolio: [
          ...
          },          
          {
            ...
            tags: ["handlebarsjs","nodejs","expressjs","mysql","javascript","moment-js","html","css","jquery","bootstrap4","heroku","fullstack","mvc"],
          ...
          },          
          {
            ...
            description: "Full Stack Application using Node and Express Servers; deployed via Heroku",
          ...
          },
          {
            ...
            description: "Command line node.js app that will search Spotify for songs, Bands in Town for concerts, and OMDB for movies based on user provided parameters or user input from text file.",
          ...
          },
          {
            ...
            description: "Application which incorporates Firebase to host train schedule (arrival and departure data). Data is manipulated with Moment.js.",
